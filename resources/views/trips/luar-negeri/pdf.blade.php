...
<head>
    ...
    <title>Surat Perjalanan Dinas Luar Negeri</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="rincian-biaya">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-left">Uang Harian ({{ $trip->tujuan }})</td>
                ...
                <tr>
                    ...
                    <td class="text-right">$ {{ number_format($trip->biaya_transport ?? 0, 2) }}</td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">1</td>
                    <td class="text-center">Paket</td>
                    <td class="text-right">$ {{ number_format($trip->biaya_hotel ?? 0, 2) }}</td>
                </tr>
                <tr class="total-row">
        ...
        <p class="terbilang">
            Terbilang: <strong>{{ ucfirst($this->terbilang($trip->total_biaya)) }} Dollar</strong>
        </p>
    </div>
    ...
    <div class="footer">
        ...
        <p class="catatan"><em>Catatan: Semua biaya dalam mata uang Dolar Amerika Serikat (USD)</em></p>
    </div>
</body>
</html>
